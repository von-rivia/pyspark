...
CREATE OR REPLACE TEMP VIEW 001_Plan_Cuentas_BSC AS
SELECT 
...
CREATE OR REPLACE TEMP VIEW 002_Saldos_Contables_BSC AS
...
CREATE OR REPLACE TEMP VIEW 003_Detalle_Contable_BSC AS
SELECT 
  a.cuenta, 
  a.descripcion, 
  a.num_cta_sbif_mdr, 
...
-- 004_700_MBMRMC
CREATE OR REPLACE TEMP VIEW 004_700_MBMRMC AS
SELECT 
...
-- 005_701_MB
CREATE OR REPLACE TEMP VIEW 005_701_MB AS
SELECT 
  Clase AS Expr1, 
...
-- 006_702_MR
CREATE OR REPLACE TEMP VIEW 006_702_MR AS
SELECT 
  Clase AS Expr1, 
  num_cta_sbif_mdr AS Expr2, 
  cuenta AS Expr3, 
...
-- 007_703_MC
CREATE OR REPLACE TEMP VIEW 007_703_MC AS
SELECT 
  Clase AS Expr1, 
  num_cta_sbif_mdr AS Expr2, 
  cuenta AS Expr3, 
...
CREATE OR REPLACE TEMP VIEW 008_Agrupador_moneda AS
SELECT 
  Clase AS Expr1, 
  num_cta_sbif_mdr AS Expr2, 
  cuenta AS Expr3, 
...
CREATE OR REPLACE TEMP VIEW 009_Agrupador_glsa_moneda AS
SELECT 
  a.num_cta_sbif_mdr, 
  a.cuenta, 
  a.descripcion, 
...
CREATE OR REPLACE TEMP VIEW 010_Genera_Interfaz_Def AS
SELECT 
