...
-- 005_701_MB
SELECT 
[004_700_Base_MBMRMC].Clase AS Expr1, 
[004_700_Base_MBMRMC].num_cta_sbif_mdr AS Expr2, 
[004_700_Base_MBMRMC].cuenta AS Expr3, 
[004_700_Base_MBMRMC].descripcion AS Expr4, 
[004_700_Base_MBMRMC].tipo_moneda AS Expr5, 
[004_700_Base_MBMRMC].cod_reaj AS Expr6, 
IIf([Clase]<>1,[sdo_peso]*-1,[sdo_peso]) AS Importe, 
[004_700_Base_MBMRMC].fecha AS Expr7
...
[004_700_Base_MBMRMC].descripcion AS Expr4, 
[004_700_Base_MBMRMC].tipo_moneda AS Expr5, 
[004_700_Base_MBMRMC].cod_reaj AS Expr6, [sdo_peso]*-1 AS Importe, 
[004_700_Base_MBMRMC].fecha AS Expr7
FROM 004_700_Base_MBMRMC
...
SELECT 
[001_700_MBMRMC].Clase AS Expr1, 
[001_700_MBMRMC].num_cta_sbif_mdr AS Expr2, 
[001_700_MBMRMC].cuenta AS Expr3, 
[001_700_MBMRMC].descripcion AS Expr4, 
[001_700_MBMRMC].tipo_moneda AS Expr5, 
[001_700_MBMRMC].cod_reaj AS Expr6, 
[001_700_MBMRMC].Importe AS Expr7, 
[001_700_MBMRMC].fecha AS Expr8, 
...
[008_Agrupador_moneda].cuenta, 
[008_Agrupador_moneda].descripcion, 
...
SELECT 
[009_Agrupador_glsa_moneda].num_cta_sbif_mdr AS Expr1, 
